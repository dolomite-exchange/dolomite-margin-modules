...
/**
 * @title   DOLOWithOwnable
 * @author  Dolomite
 *
 * ERC20 contract for DOLO token
 */
contract DOLOWithOwnable is ERC20Burnable, Ownable, IDOLO {
    ...
    bytes32 private constant _FILE = "DOLOWithOwnable";
    ...
    constructor(address _owner) ERC20("Dolomite", "DOLO") {
    ...
    function ownerSetCCIPAdmin(address _newAdmin) external onlyOwner {
        _ownerSetCCIPAdmin(_newAdmin);
    }

    function ownerSetMinter(address _minter, bool _isMinter) external onlyOwner {
        _ownerSetMinter(_minter, _isMinter);
    }

    function renounceOwnership() public view override onlyOwner {
        revert("DOLOWithOwnable: Not implemented");
    }
    ...
    function owner() public view override(IDOLO, Ownable) returns (address) {
