...
import InfraredAirdrop from '../../../../../../berachain/infrared-vaults-airdrop.json';
...
async function main(): Promise<DryRunOutput<Network.Berachain>> {
  ...
  const preBal = await core.tokens.ir.balanceOf(core.gnosisSafeAddress);
  const allUsers = InfraredAirdrop;
