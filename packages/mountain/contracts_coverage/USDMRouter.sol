...
contract USDMRouter {
    ...
    function withdrawUSDM(
        ...
        _unwrapUSDMAndSend(_amountWei == type(uint256).max ? W_USDM.balanceOf(address(this)) : _amountWei, msg.sender);
    }
    ...
    function _unwrapUSDMAndSend(uint256 _amount, address _receiver) internal returns (uint256) {
