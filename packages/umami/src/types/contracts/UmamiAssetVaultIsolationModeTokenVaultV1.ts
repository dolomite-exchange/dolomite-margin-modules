...
export interface UmamiAssetVaultIsolationModeTokenVaultV1Interface
...
export interface UmamiAssetVaultIsolationModeTokenVaultV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UmamiAssetVaultIsolationModeTokenVaultV1Interface;
