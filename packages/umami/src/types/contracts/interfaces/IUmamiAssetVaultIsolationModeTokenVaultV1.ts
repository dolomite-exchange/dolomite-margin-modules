...
export interface IUmamiAssetVaultIsolationModeTokenVaultV1Interface
...
export interface IUmamiAssetVaultIsolationModeTokenVaultV1
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IUmamiAssetVaultIsolationModeTokenVaultV1Interface;
