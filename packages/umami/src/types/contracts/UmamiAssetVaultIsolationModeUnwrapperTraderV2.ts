...
export interface UmamiAssetVaultIsolationModeUnwrapperTraderV2Interface
...
export interface UmamiAssetVaultIsolationModeUnwrapperTraderV2
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UmamiAssetVaultIsolationModeUnwrapperTraderV2Interface;
