...
export interface IIsolationModeTokenVaultV1WithPausableInterface
...
export interface IIsolationModeTokenVaultV1WithPausable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IIsolationModeTokenVaultV1WithPausableInterface;
