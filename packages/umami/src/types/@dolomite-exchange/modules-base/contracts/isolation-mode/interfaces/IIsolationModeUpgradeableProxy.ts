...
export interface IIsolationModeUpgradeableProxyInterface
...
export interface IIsolationModeUpgradeableProxy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IIsolationModeUpgradeableProxyInterface;
