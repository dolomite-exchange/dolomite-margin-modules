...
import type {
  ...
  IsolationModeTokenVaultV1WithPausableInterface,
} from "../../../../../../@dolomite-exchange/modules-base/contracts/isolation-mode/abstract/IsolationModeTokenVaultV1WithPausable";
...
export class IsolationModeTokenVaultV1WithPausable__factory {
  static readonly abi = _abi;
  static createInterface(): IsolationModeTokenVaultV1WithPausableInterface {
    return new utils.Interface(
      _abi
    ) as IsolationModeTokenVaultV1WithPausableInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as IsolationModeTokenVaultV1WithPausable;
  }
}
