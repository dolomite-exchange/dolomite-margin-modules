...
import { IGmxExchangeRouterV22 } from "./interfaces/IGmxExchangeRouterV22.sol";
import { IGmxV22IsolationModeUnwrapperTraderV2 } from "./interfaces/IGmxV22IsolationModeUnwrapperTraderV2.sol";
import { IGmxV2IsolationModeVaultFactory } from "./interfaces/IGmxV2IsolationModeVaultFactory.sol";
import { IGmxV22IsolationModeWrapperTraderV2 } from "./interfaces/IGmxV22IsolationModeWrapperTraderV2.sol";
...
library GmxV22TraderLibrary {
    ...
    function wrapperCreateDeposit(
        ...
        IGmxExchangeRouterV22 exchangeRouter = IGmxExchangeRouterV22(address(_registry.gmxExchangeRouter()));
        ...
        IGmxExchangeRouterV22.CreateDepositParamsAddresses memory addresses = IGmxExchangeRouterV22.CreateDepositParamsAddresses(
        ...
        IGmxExchangeRouterV22.CreateDepositParams memory depositParams = IGmxExchangeRouterV22.CreateDepositParams(
            /* addresses = */ addresses,
    ...
    function initiateCancelDeposit(IGmxV22IsolationModeWrapperTraderV2 _wrapper, bytes32 _key) public {
    ...
    function unwrapperInitiateCancelWithdrawal(IGmxV22IsolationModeUnwrapperTraderV2 _unwrapper, bytes32 _key) public {
    ...
    function unwrapperExecuteInitiateUnwrapping(
        ...
        IGmxExchangeRouterV22 exchangeRouter = IGmxExchangeRouterV22(address(registry.gmxExchangeRouter()));
        ...
        IGmxExchangeRouterV22.CreateWithdrawalParamsAddresses memory addresses = IGmxExchangeRouterV22.CreateWithdrawalParamsAddresses(
        ...
        IGmxExchangeRouterV22.CreateWithdrawalParams memory withdrawalParams = IGmxExchangeRouterV22.CreateWithdrawalParams(
            /* addresses = */ addresses,
    ...
    function validateEventDataForWithdrawal(
        ...
        IGmxV22IsolationModeUnwrapperTraderV2.WithdrawalInfo memory _withdrawalInfo
    ) public view {
        Require.that(
