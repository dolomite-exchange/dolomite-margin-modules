...
import { GmxV22TraderLibrary } from "./GmxV22TraderLibrary.sol";
...
/**
 * @title   GmxV22IsolationModeUnwrapperTraderV2
 * @author  Dolomite
 *
 * @notice  Used for unwrapping GMX GM (via withdrawing from GMX)
 */
contract GmxV22IsolationModeUnwrapperTraderV2 is
    IGmxV22IsolationModeUnwrapperTraderV2,
    UpgradeableAsyncIsolationModeUnwrapperTrader
{
    ...
    function vaultInitiateUnwrapping(
        ...
        bytes32 withdrawalKey = GmxV22TraderLibrary.unwrapperExecuteInitiateUnwrapping(
            factory,
            /* _vault = */ msg.sender,
            _inputAmount,
            _outputToken,
    ...
    function initiateCancelWithdrawal(bytes32 _key) external {
        GmxV22TraderLibrary.unwrapperInitiateCancelWithdrawal(/* _unwrapper = */ this, _key);
    }
    ...
    onlyHandler(msg.sender) {
        ...
        GmxV22TraderLibrary.validateEventDataForWithdrawal(
    ...
    returns (bool) {
        return GmxV22TraderLibrary.isValidInputOrOutputToken(
            IGmxV2IsolationModeVaultFactory(address(VAULT_FACTORY())),
            _outputToken,
            skipLongToken()
        );
