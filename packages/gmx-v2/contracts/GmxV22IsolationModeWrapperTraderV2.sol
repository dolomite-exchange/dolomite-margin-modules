...
/**
 * @title   GmxV22IsolationModeWrapperTraderV2
 * @author  Dolomite
 *
 * @notice  Used for wrapping GMX GM tokens (via depositing into GMX)
 */
contract GmxV22IsolationModeWrapperTraderV2 is
    IGmxV22IsolationModeWrapperTraderV2,
    UpgradeableAsyncIsolationModeWrapperTrader
{
    ...
    function initiateCancelDeposit(bytes32 _key) external {
        GmxV22TraderLibrary.initiateCancelDeposit(/* _wrapper = */ this, _key);
    }
    ...
    function _createDepositWithExternalProtocol(
        ...
        return GmxV22TraderLibrary.wrapperCreateDeposit(
            IGmxV2IsolationModeVaultFactory(address(VAULT_FACTORY())),
            GMX_REGISTRY_V2(),
            WETH,
            _vault,
