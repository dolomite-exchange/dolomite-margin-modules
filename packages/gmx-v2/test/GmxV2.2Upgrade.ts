...
describe('GmxV2.2Upgrade', () => {
  ...
  before(async () => {
    ...
    const usdcProviderKey = getOracleProviderForTokenKey(ORACLE_V22, core.tokens.nativeUsdc);
    const wethProviderKey = getOracleProviderForTokenKey(ORACLE_V22, core.tokens.weth);
