...
export interface GmxV2IsolationModeTokenVaultV1Interface
...
export interface GmxV2IsolationModeTokenVaultV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GmxV2IsolationModeTokenVaultV1Interface;
