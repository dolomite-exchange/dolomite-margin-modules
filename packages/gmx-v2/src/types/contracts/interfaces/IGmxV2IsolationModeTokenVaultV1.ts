...
export interface IGmxV2IsolationModeTokenVaultV1Interface
...
export interface IGmxV2IsolationModeTokenVaultV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IGmxV2IsolationModeTokenVaultV1Interface;
