...
export interface IGmxWithdrawalCallbackReceiverInterface
...
export interface IGmxWithdrawalCallbackReceiver extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IGmxWithdrawalCallbackReceiverInterface;
