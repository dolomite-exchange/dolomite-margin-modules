...
export interface IIsolationModeTokenVaultV1WithFreezableInterface
...
export interface IIsolationModeTokenVaultV1WithFreezable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IIsolationModeTokenVaultV1WithFreezableInterface;
