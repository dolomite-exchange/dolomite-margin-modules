...
export interface UpgradeableAsyncIsolationModeWrapperTraderInterface
...
export interface UpgradeableAsyncIsolationModeWrapperTrader
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UpgradeableAsyncIsolationModeWrapperTraderInterface;
