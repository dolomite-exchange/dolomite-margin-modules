...
} from "../../../../../@dolomite-exchange/modules-base/contracts/general/HandlerRegistry";
...
export class HandlerRegistry__factory {
  static readonly abi = _abi;
  static createInterface(): HandlerRegistryInterface {
    return new utils.Interface(_abi) as HandlerRegistryInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): HandlerRegistry {
    return new Contract(address, _abi, signerOrProvider) as HandlerRegistry;
  }
}
