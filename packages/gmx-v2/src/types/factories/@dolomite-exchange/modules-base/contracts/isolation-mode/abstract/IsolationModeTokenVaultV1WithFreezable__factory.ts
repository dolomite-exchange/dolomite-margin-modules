...
import type {
  ...
  IsolationModeTokenVaultV1WithFreezableInterface,
} from "../../../../../../@dolomite-exchange/modules-base/contracts/isolation-mode/abstract/IsolationModeTokenVaultV1WithFreezable";
...
export class IsolationModeTokenVaultV1WithFreezable__factory {
  static readonly abi = _abi;
  static createInterface(): IsolationModeTokenVaultV1WithFreezableInterface {
    return new utils.Interface(
      _abi
    ) as IsolationModeTokenVaultV1WithFreezableInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as IsolationModeTokenVaultV1WithFreezable;
  }
}
