...
import type {
  ...
  IGLPIsolationModeVaultFactoryInterface,
} from "../../../../../@dolomite-exchange/modules-glp/contracts/interfaces/IGLPIsolationModeVaultFactory";
...
export class IGLPIsolationModeVaultFactory__factory {
  static readonly abi = _abi;
  static createInterface(): IGLPIsolationModeVaultFactoryInterface {
    return new utils.Interface(_abi) as IGLPIsolationModeVaultFactoryInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as IGLPIsolationModeVaultFactory;
  }
}
