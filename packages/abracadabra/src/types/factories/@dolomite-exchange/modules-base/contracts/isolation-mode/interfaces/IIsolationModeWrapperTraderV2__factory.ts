...
import type {
  ...
  IIsolationModeWrapperTraderV2Interface,
} from "../../../../../../@dolomite-exchange/modules-base/contracts/isolation-mode/interfaces/IIsolationModeWrapperTraderV2";
...
export class IIsolationModeWrapperTraderV2__factory {
  static readonly abi = _abi;
  static createInterface(): IIsolationModeWrapperTraderV2Interface {
    return new utils.Interface(_abi) as IIsolationModeWrapperTraderV2Interface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as IIsolationModeWrapperTraderV2;
  }
}
