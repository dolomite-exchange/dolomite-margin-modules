...
export interface MagicGLPUnwrapperTraderV2Interface extends utils.Interface {
  functions: {
...
export interface MagicGLPUnwrapperTraderV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MagicGLPUnwrapperTraderV2Interface;
