...
export interface MagicGLPWrapperTraderV2Interface extends utils.Interface {
  functions: {
...
export interface MagicGLPWrapperTraderV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MagicGLPWrapperTraderV2Interface;
