...
import { IDolomiteMarginWrapperTraderForLiquidatorV3 } from "@dolomite-exchange/modules-base/contracts/interfaces/IDolomiteMarginWrapperTraderForLiquidatorV3.sol"; // solhint-disable-line max-line-length
...
/**
 * @title   MagicGLPWrapperTraderV1
 * @author  Dolomite
 *
 * @notice  Used for wrapping any supported token into magicGLP. Upon settlement, the minted magicGLP is sent to
 *          DolomiteMargin.
 */
contract MagicGLPWrapperTraderV1 is IDolomiteMarginWrapperTraderForLiquidatorV3, OnlyDolomiteMargin {
    using GLPMathLib for IGmxVault;
    using SafeERC20 for IERC20;

    // ============ Constants ============

    bytes32 private constant _FILE = "MagicGLPWrapperTraderV1";
