...
import { IIsolationModeVaultFactoryOld } from "@dolomite-exchange/modules-base/contracts/isolation-mode/interfaces/IIsolationModeVaultFactoryOld.sol"; // solhint-disable-line max-line-length
import { IGmxRegistryV1 } from "./IGmxRegistryV1.sol";


/**
 * @title   IGLPIsolationModeVaultFactoryOld
 * @author  Dolomite
 *
 * @notice  Interface for a subclass of IsolationModeVaultFactory that creates vaults for staked-GLP tokens.
 */
interface IGLPIsolationModeVaultFactoryOld is IIsolationModeVaultFactoryOld {
