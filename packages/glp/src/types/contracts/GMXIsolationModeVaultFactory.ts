...
export interface GMXIsolationModeVaultFactoryInterface extends utils.Interface {
  functions: {
    ...
    "executeDepositIntoVaultFromGLPVault(address,uint256,uint256,bool)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "executeDepositIntoVaultFromGLPVault"
      | "getAccountByVault"
  ...
  encodeFunctionData(
    functionFragment: "executeDepositIntoVaultFromGLPVault",
  ...
  encodeFunctionData(
    functionFragment: "setGmxRegistry",
    values: [string]
  ): string;
...
export type GmxRegistrySetEvent = TypedEvent<
  [string],
  GmxRegistrySetEventObject
>;
...
export interface GMXIsolationModeVaultFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GMXIsolationModeVaultFactoryInterface;
