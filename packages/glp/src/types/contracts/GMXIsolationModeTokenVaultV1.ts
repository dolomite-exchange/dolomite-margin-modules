...
export interface GMXIsolationModeTokenVaultV1Interface extends utils.Interface {
  functions: {
...
export interface GMXIsolationModeTokenVaultV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GMXIsolationModeTokenVaultV1Interface;
