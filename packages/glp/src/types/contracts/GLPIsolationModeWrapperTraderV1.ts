...
export interface GLPIsolationModeWrapperTraderV1Interface
...
export interface GLPIsolationModeWrapperTraderV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GLPIsolationModeWrapperTraderV1Interface;
