...
export interface TestGMXIsolationModeTokenVaultV1Interface
...
export interface TestGMXIsolationModeTokenVaultV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestGMXIsolationModeTokenVaultV1Interface;
