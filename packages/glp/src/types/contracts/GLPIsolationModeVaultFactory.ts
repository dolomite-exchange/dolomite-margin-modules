...
export interface GLPIsolationModeVaultFactoryInterface extends utils.Interface {
  functions: {
...
export interface GLPIsolationModeVaultFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GLPIsolationModeVaultFactoryInterface;
