...
export interface IGLPIsolationModeVaultFactoryOldInterface
...
export interface IGLPIsolationModeVaultFactoryOld extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IGLPIsolationModeVaultFactoryOldInterface;
