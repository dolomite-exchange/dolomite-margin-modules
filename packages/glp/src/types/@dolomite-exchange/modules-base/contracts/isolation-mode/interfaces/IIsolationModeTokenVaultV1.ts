...
export interface IIsolationModeTokenVaultV1Interface extends utils.Interface {
  functions: {
...
export interface IIsolationModeTokenVaultV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IIsolationModeTokenVaultV1Interface;
