...
/**
 * @title   IGlvIsolationModeTokenVaultV1
 * @author  Dolomite
 *
 */
interface IGlvIsolationModeTokenVaultV1 is IIsolationModeTokenVaultV1WithAsyncFreezableAndPausable {

    function registry() external view returns (IGlvRegistry);
}
