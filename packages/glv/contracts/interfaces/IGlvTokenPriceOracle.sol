...
/**
 * @title   IGlvTokenPriceOracle
 * @author  Dolomite
 *
 * @notice  Interface for the GlvTokenPriceOracle to report GLV token prices
 */
interface IGlvTokenPriceOracle is IDolomitePriceOracle {
