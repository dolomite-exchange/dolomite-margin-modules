...
import { GlvIsolationModeTokenVaultV1 } from "../GlvIsolationModeTokenVaultV1.sol"; // solhint-disable-line max-line-length


/**
 * @title   TestGlvIsolationModeTokenVaultV1
 * @author  Dolomite
 *
 * @notice  Test implementation for exposing areas for coverage testing
 */
contract TestGlvIsolationModeTokenVaultV1 is GlvIsolationModeTokenVaultV1 {
    ...
    constructor(address _weth, uint256 _chainId) GlvIsolationModeTokenVaultV1(_weth, _chainId) {
