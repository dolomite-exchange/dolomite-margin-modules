...
export interface IsolationModeWrapperTraderV1Interface extends utils.Interface {
  functions: {
...
export interface IsolationModeWrapperTraderV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsolationModeWrapperTraderV1Interface;
