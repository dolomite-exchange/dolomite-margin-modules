...
export interface IsolationModeTokenVaultV1WithPausableInterface
...
export interface IsolationModeTokenVaultV1WithPausable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsolationModeTokenVaultV1WithPausableInterface;
