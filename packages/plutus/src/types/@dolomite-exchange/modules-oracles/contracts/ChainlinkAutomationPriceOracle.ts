...
export interface ChainlinkAutomationPriceOracleInterface
...
export interface ChainlinkAutomationPriceOracle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ChainlinkAutomationPriceOracleInterface;
