...
import type {
  ...
  IGMXIsolationModeVaultFactoryInterface,
} from "../../../../../@dolomite-exchange/modules-glp/contracts/interfaces/IGMXIsolationModeVaultFactory";
...
const _abi = [
  ...
  },
  {
    ...
    name: "executeDepositIntoVaultFromGLPVault",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
...
export class IGMXIsolationModeVaultFactory__factory {
  static readonly abi = _abi;
  static createInterface(): IGMXIsolationModeVaultFactoryInterface {
    return new utils.Interface(_abi) as IGMXIsolationModeVaultFactoryInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as IGMXIsolationModeVaultFactory;
  }
}
