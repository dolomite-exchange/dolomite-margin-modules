...
import type {
  ...
  IsolationModeUnwrapperTraderV1Interface,
} from "../../../../../../@dolomite-exchange/modules-base/contracts/isolation-mode/abstract/IsolationModeUnwrapperTraderV1";
...
export class IsolationModeUnwrapperTraderV1__factory {
  static readonly abi = _abi;
  static createInterface(): IsolationModeUnwrapperTraderV1Interface {
    return new utils.Interface(_abi) as IsolationModeUnwrapperTraderV1Interface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as IsolationModeUnwrapperTraderV1;
  }
}
