...
import type {
  ...
  IsolationModeWrapperTraderV1Interface,
} from "../../../../../../@dolomite-exchange/modules-base/contracts/isolation-mode/abstract/IsolationModeWrapperTraderV1";
...
export class IsolationModeWrapperTraderV1__factory {
  static readonly abi = _abi;
  static createInterface(): IsolationModeWrapperTraderV1Interface {
    return new utils.Interface(_abi) as IsolationModeWrapperTraderV1Interface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as IsolationModeWrapperTraderV1;
  }
}
