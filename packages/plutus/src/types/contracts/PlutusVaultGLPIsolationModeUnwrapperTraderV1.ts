...
export interface PlutusVaultGLPIsolationModeUnwrapperTraderV1Interface
...
export interface PlutusVaultGLPIsolationModeUnwrapperTraderV1
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PlutusVaultGLPIsolationModeUnwrapperTraderV1Interface;
