...
export interface PlutusVaultRegistryInterface extends utils.Interface {
  functions: {
...
export interface PlutusVaultRegistry extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PlutusVaultRegistryInterface;
