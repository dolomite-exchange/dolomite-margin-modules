...
export interface PlutusVaultGLPWithChainlinkAutomationPriceOracleInterface
...
export interface PlutusVaultGLPWithChainlinkAutomationPriceOracle
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PlutusVaultGLPWithChainlinkAutomationPriceOracleInterface;
