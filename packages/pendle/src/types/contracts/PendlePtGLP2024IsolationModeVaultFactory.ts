...
export interface PendlePtGLP2024IsolationModeVaultFactoryInterface
  ...
  functions: {
    ...
    "ownerSetPendlePtGLP2024Registry(address)": FunctionFragment;
    "ownerSetUserVaultImplementation(address)": FunctionFragment;
    "pendlePtGLP2024Registry()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "ownerSetPendlePtGLP2024Registry"
  ...
  encodeFunctionData(
    functionFragment: "ownerSetPendlePtGLP2024Registry",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "pendlePtGLP2024Registry",
    values?: undefined
  ): string;
  ...
  events: {
    ...
    "PendlePtGLP2024RegistrySet(address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "PendlePtGLP2024RegistrySet"): EventFragment;
...
export interface PendlePtGLP2024RegistrySetEventObject {
  _pendlePtGLP2024Registry: string;
}
export type PendlePtGLP2024RegistrySetEvent = TypedEvent<
  [string],
  PendlePtGLP2024RegistrySetEventObject
>;

export type PendlePtGLP2024RegistrySetEventFilter =
  TypedEventFilter<PendlePtGLP2024RegistrySetEvent>;
...
export interface PendlePtGLP2024IsolationModeVaultFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PendlePtGLP2024IsolationModeVaultFactoryInterface;
  ...
  functions: {
    ...
    pendlePtGLP2024Registry(overrides?: CallOverrides): Promise<[string]>;
  ...
  filters: {
    ...
    "PendlePtGLP2024RegistrySet(address)"(
      _pendlePtGLP2024Registry?: null
    ): PendlePtGLP2024RegistrySetEventFilter;
    PendlePtGLP2024RegistrySet(
      _pendlePtGLP2024Registry?: null
    ): PendlePtGLP2024RegistrySetEventFilter;
  ...
  estimateGas: {
    ...
    pendlePtGLP2024Registry(overrides?: CallOverrides): Promise<BigNumber>;
