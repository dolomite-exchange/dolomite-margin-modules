...
export interface IPendlePtIsolationModeVaultFactoryInterface
...
export interface IPendlePtIsolationModeVaultFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPendlePtIsolationModeVaultFactoryInterface;
