...
export interface IPendleYtGLP2024IsolationModeVaultFactoryInterface
...
export interface IPendleYtGLP2024IsolationModeVaultFactory
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPendleYtGLP2024IsolationModeVaultFactoryInterface;
  ...
  functions: {
    ...
    ownerSetYtMaturityTimestamp(
      _ytMaturityTimstamp: BigNumberish,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
