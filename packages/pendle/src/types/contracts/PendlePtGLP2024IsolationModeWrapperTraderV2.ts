...
export interface PendlePtGLP2024IsolationModeWrapperTraderV2Interface
...
export interface PendlePtGLP2024IsolationModeWrapperTraderV2
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PendlePtGLP2024IsolationModeWrapperTraderV2Interface;
