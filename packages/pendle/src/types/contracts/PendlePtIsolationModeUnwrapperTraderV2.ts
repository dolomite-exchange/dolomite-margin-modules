...
export interface PendlePtIsolationModeUnwrapperTraderV2Interface
...
export interface PendlePtIsolationModeUnwrapperTraderV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PendlePtIsolationModeUnwrapperTraderV2Interface;
