...
export interface IGLPIsolationModeVaultFactoryInterface
...
export interface IGLPIsolationModeVaultFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IGLPIsolationModeVaultFactoryInterface;
