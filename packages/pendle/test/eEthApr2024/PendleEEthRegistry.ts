...
describe('PendleEEthApr2024Registry', () => {
  ...
  before(async () => {
    ...
    syToken = core.pendleEcosystem!.syWeEthToken;

    registry = await createPendleRegistry(core, ptMarket, core.pendleEcosystem!.weEthApr2024.ptOracle, syToken);
  ...
  describe('#initialize', () => {
    it('should initialize variables properly', async () => {
      ...
      expect(await registry.ptOracle()).to.equal(core.pendleEcosystem!.weEthApr2024.ptOracle.address);
