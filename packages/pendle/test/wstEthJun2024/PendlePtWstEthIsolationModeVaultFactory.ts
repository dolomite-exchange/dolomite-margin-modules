...
describe('PendlePtWstEthJun2024IsolationModeVaultFactory', () => {
  ...
  describe('#contructor', () => {
    it('should initialize variables properly', async () => {
      ...
      expect(await factory.UNDERLYING_TOKEN()).to.equal(core.pendleEcosystem!.wstEthJun2024.ptWstEthToken.address);
