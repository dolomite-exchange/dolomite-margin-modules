...
describe('PendleWstEthJun2024Registry', () => {
  ...
  before(async () => {
    ...
    registry = await createPendleRegistry(core, ptMarket, core.pendleEcosystem!.wstEthJun2024.ptOracle, syToken);
  ...
  describe('#initialize', () => {
    it('should initialize variables properly', async () => {
      ...
      expect(await registry.ptOracle()).to.equal(core.pendleEcosystem!.wstEthJun2024.ptOracle.address);
    ...
    it('should fail if already initialized', async () => {
      await expectThrow(
        registry.initialize(
          ...
          ptMarket.address,
          core.pendleEcosystem!.wstEthJun2024.ptOracle.address,
          syToken.address,
