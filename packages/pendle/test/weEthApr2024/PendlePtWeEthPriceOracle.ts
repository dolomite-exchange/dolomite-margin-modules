...
import { WE_ETH_USD_REDSTONE_FEED_MAP } from '@dolomite-exchange/modules-base/src/utils/constants';
...
describe('PendlePtWeEthApr2024PriceOracle', () => {
  ...
  before(async () => {
    ...
    await core.chainlinkPriceOracle!.connect(core.governance).ownerInsertOrUpdateOracleToken(
      ...
      18,
      WE_ETH_USD_REDSTONE_FEED_MAP[core.config.network]!,
      ADDRESS_ZERO,
    );
