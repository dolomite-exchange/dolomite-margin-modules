...
describe('PendleWstEthJun2025Registry', () => {
  ...
  before(async () => {
    ...
    ptMarket = core.pendleEcosystem!.wstEthJun2025.ptWstEthMarket;
    syToken = core.pendleEcosystem!.syWstEthToken;

    registry = await createPendleRegistry(core, ptMarket, core.pendleEcosystem!.wstEthJun2025.ptOracle, syToken);
  ...
  describe('#initialize', () => {
    it('should initialize variables properly', async () => {
      ...
      expect(await registry.ptOracle()).to.equal(core.pendleEcosystem!.wstEthJun2025.ptOracle.address);
    ...
    it('should fail if already initialized', async () => {
      await expectThrow(
        registry.initialize(
          ...
          ptMarket.address,
          core.pendleEcosystem!.wstEthJun2025.ptOracle.address,
          syToken.address,
