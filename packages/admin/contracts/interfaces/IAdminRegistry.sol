...
interface IAdminRegistry {
    ...
    function grantRole(bytes4 _selector, address _contract, address _account) external;

    function revokeRole(bytes4 _selector, address _contract, address _account) external;
