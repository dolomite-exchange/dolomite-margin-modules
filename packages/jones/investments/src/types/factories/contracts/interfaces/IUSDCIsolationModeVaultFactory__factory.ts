...
import type {
  ...
  IUSDCIsolationModeVaultFactoryInterface,
} from "../../../contracts/interfaces/IUSDCIsolationModeVaultFactory";
...
export class IUSDCIsolationModeVaultFactory__factory {
  static readonly abi = _abi;
  static createInterface(): IUSDCIsolationModeVaultFactoryInterface {
    return new utils.Interface(_abi) as IUSDCIsolationModeVaultFactoryInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as IUSDCIsolationModeVaultFactory;
  }
}
