...
import type {
  ...
  IUSDCIsolationModeTokenVaultV1Interface,
} from "../../../contracts/interfaces/IUSDCIsolationModeTokenVaultV1";
...
export class IUSDCIsolationModeTokenVaultV1__factory {
  static readonly abi = _abi;
  static createInterface(): IUSDCIsolationModeTokenVaultV1Interface {
    return new utils.Interface(_abi) as IUSDCIsolationModeTokenVaultV1Interface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as IUSDCIsolationModeTokenVaultV1;
  }
}
