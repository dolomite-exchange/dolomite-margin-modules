...
export interface IEventEmitterRegistryInterface extends utils.Interface {
  functions: {
    ...
    "emitRewardClaimed(address,uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "emitRewardClaimed",
...
export interface IEventEmitterRegistry extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IEventEmitterRegistryInterface;
