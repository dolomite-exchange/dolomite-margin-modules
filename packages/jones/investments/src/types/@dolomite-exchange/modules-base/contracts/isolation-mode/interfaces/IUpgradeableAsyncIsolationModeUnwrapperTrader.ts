...
export interface IUpgradeableAsyncIsolationModeUnwrapperTraderInterface
  ...
  functions: {
    ...
    "executeWithdrawalCancellation(bytes32)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "emitWithdrawalExecuted",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "executeWithdrawalCancellation",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
...
export interface IUpgradeableAsyncIsolationModeUnwrapperTrader
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IUpgradeableAsyncIsolationModeUnwrapperTraderInterface;
