...
export interface IExpiryV2Interface extends utils.Interface {
  functions: {
    "g_expiryRampTime()": FunctionFragment;
    "getExpiry((address,uint256),uint256)": FunctionFragment;
    "getLiquidationSpreadAdjustedPrices((address,uint256),uint256,uint256,uint32)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "getLiquidationSpreadAdjustedPrices",
    values: [
...
export interface IExpiryV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IExpiryV2Interface;
