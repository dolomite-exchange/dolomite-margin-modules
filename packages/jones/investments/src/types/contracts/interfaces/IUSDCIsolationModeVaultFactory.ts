...
export interface IUSDCIsolationModeVaultFactoryInterface
  ...
  encodeFunctionData(
    functionFragment: "ownerSetUSDCRegistry",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "USDCRegistrySet(address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "USDCRegistrySet"): EventFragment;
...
export interface USDCRegistrySetEventObject {
  _usdcRegistry: string;
}
export type USDCRegistrySetEvent = TypedEvent<
  [string],
  USDCRegistrySetEventObject
>;

export type USDCRegistrySetEventFilter = TypedEventFilter<USDCRegistrySetEvent>;
...
export interface IUSDCIsolationModeVaultFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IUSDCIsolationModeVaultFactoryInterface;
  ...
  functions: {
    ...
    usdcRegistry(overrides?: CallOverrides): Promise<[string]>;
  ...
  filters: {
    ...
    "USDCRegistrySet(address)"(
      _usdcRegistry?: null
    ): USDCRegistrySetEventFilter;
    USDCRegistrySet(_usdcRegistry?: null): USDCRegistrySetEventFilter;
  ...
  estimateGas: {
    ...
    usdcRegistry(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    usdcRegistry(overrides?: CallOverrides): Promise<PopulatedTransaction>;
