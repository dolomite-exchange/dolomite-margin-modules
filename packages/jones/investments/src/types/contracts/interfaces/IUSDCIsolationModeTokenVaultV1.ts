...
export interface IUSDCIsolationModeTokenVaultV1Interface
...
export interface IUSDCIsolationModeTokenVaultV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IUSDCIsolationModeTokenVaultV1Interface;
