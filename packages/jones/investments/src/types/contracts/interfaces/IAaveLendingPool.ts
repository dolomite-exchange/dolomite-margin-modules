...
export declare namespace IAaveLendingPool {
  ...
  export type ReserveDataStruct = {
    configuration: IAaveLendingPool.ReserveConfigurationMapStruct;
  ...
  export type ReserveDataStructOutput = [
    IAaveLendingPool.ReserveConfigurationMapStructOutput,
    BigNumber,
    BigNumber,
    BigNumber,
    BigNumber,
    ...
    configuration: IAaveLendingPool.ReserveConfigurationMapStructOutput;
...
export interface IAaveLendingPoolInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic: "getReserveData" | "supply" | "withdraw"
  ): FunctionFragment;
...
export interface IAaveLendingPool extends BaseContract {
  ...
  functions: {
    ...
    ): Promise<[IAaveLendingPool.ReserveDataStructOutput]>;
