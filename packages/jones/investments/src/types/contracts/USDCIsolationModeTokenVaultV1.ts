...
export interface USDCIsolationModeTokenVaultV1Interface
  ...
  functions: {
    ...
    "accountNumberToStrategy(uint256)": FunctionFragment;
    ...
    "adjustAccountBalance(uint256,uint256)": FunctionFragment;
    "borrowToIncreaseStrategySize(uint256,uint256,uint8,uint256,bytes)": FunctionFragment;
    ...
    "decreaseStrategySizeAndRepayDebt(uint256,uint256,uint8,uint256,bytes)": FunctionFragment;
    "decreaseStrategySizeAndTransfer(uint256,uint256,uint8,uint256,bytes)": FunctionFragment;
    ...
    "getBalanceForSubaccount(uint256)": FunctionFragment;
    ...
    "transferToIncreaseStrategySize(uint256,uint256,uint8,uint256,bytes)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "transferToIncreaseStrategySize"
      | "underlyingBalanceOf"
  ...
  encodeFunctionData(
    functionFragment: "accountNumberToStrategy",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "adjustAccountBalance",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "borrowToIncreaseStrategySize",
  ...
  encodeFunctionData(
    functionFragment: "decreaseStrategySizeAndRepayDebt",
    values: [BigNumberish, BigNumberish, BigNumberish, BigNumberish, BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "decreaseStrategySizeAndTransfer",
    values: [BigNumberish, BigNumberish, BigNumberish, BigNumberish, BytesLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getBalanceForSubaccount",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "transferToIncreaseStrategySize",
    values: [BigNumberish, BigNumberish, BigNumberish, BigNumberish, BytesLike]
  ): string;
  encodeFunctionData(
...
export interface USDCIsolationModeTokenVaultV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: USDCIsolationModeTokenVaultV1Interface;
