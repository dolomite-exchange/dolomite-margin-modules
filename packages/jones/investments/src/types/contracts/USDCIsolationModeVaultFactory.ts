...
export interface USDCIsolationModeVaultFactoryInterface
...
export interface USDCIsolationModeVaultFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: USDCIsolationModeVaultFactoryInterface;
