...
export interface OnlyDolomiteMarginInterface extends utils.Interface {
  functions: {
...
export interface OnlyDolomiteMargin extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OnlyDolomiteMarginInterface;
