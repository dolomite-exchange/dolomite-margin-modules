...
export interface IsolationModeTokenVaultV1WithPausableAndOnlyEoaInterface
...
export interface IsolationModeTokenVaultV1WithPausableAndOnlyEoa
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsolationModeTokenVaultV1WithPausableAndOnlyEoaInterface;
