...
export interface JonesUSDCIsolationModeUnwrapperTraderV2ForLiquidationInterface
...
export interface JonesUSDCIsolationModeUnwrapperTraderV2ForLiquidation
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: JonesUSDCIsolationModeUnwrapperTraderV2ForLiquidationInterface;
