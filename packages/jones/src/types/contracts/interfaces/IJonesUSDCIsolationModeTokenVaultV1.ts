...
export interface IJonesUSDCIsolationModeTokenVaultV1Interface
...
export interface IJonesUSDCIsolationModeTokenVaultV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IJonesUSDCIsolationModeTokenVaultV1Interface;
