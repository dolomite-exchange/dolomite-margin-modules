...
export interface IJonesUSDCRegistryInterface extends utils.Interface {
  functions: {
...
export interface IJonesUSDCRegistry extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IJonesUSDCRegistryInterface;
