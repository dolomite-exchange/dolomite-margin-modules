...
export interface IOnlyDolomiteMarginInterface extends utils.Interface {
  functions: {
...
export interface IOnlyDolomiteMargin extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IOnlyDolomiteMarginInterface;
