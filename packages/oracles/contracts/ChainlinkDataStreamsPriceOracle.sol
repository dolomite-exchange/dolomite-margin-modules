...
contract ChainlinkDataStreamsPriceOracle is IChainlinkDataStreamsPriceOracle, OnlyDolomiteMargin {
    ...
    IVerifierProxy public immutable VERIFIER_PROXY; // @follow-up Consider if we should make this not immutable
        ...
        OnlyDolomiteMargin(_dolomiteMargin)
    {
        ...
        // @follow-up Do we want to approve here or let the admin do it?
    ...
    // @todo Add whitelisted callers and wait for more data stream guidance + direction
    function postPrices(
