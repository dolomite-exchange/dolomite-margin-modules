...
import { IChainlinkPriceOracleV2 } from "./IChainlinkPriceOracleV2.sol";
 ...
 */
interface IOracleAggregator is IDolomitePriceOracle {
     ...
     */
    function getOracleByToken(address _token) external view returns (IChainlinkPriceOracleV2);
}
