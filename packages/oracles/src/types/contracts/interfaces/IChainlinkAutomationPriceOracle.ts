...
export interface IChainlinkAutomationPriceOracleInterface
...
export interface IChainlinkAutomationPriceOracle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IChainlinkAutomationPriceOracleInterface;
