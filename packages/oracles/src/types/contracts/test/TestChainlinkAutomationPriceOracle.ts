...
export interface TestChainlinkAutomationPriceOracleInterface
  extends utils.Interface {
  functions: {
    "DOLOMITE_MARGIN()": FunctionFragment;
    "MARKET_ID()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "MARKET_ID", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "MARKET_ID", data: BytesLike): Result;
...
export interface TestChainlinkAutomationPriceOracle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestChainlinkAutomationPriceOracleInterface;
  ...
  functions: {
    ...
    MARKET_ID(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    MARKET_ID(overrides?: CallOverrides): Promise<PopulatedTransaction>;
