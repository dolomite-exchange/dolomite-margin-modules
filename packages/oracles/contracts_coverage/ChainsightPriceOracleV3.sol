...
contract ChainsightPriceOracleV3 is IChainsightPriceOracleV3, OnlyDolomiteMargin {
        ...
        OnlyDolomiteMargin(_dolomiteMargin)
    {
        ...
        if (_keys.length == _invertPrice.length) { /* FOR COVERAGE TESTING */ }
        Require.that(
    ...
    function _ownerSetChainsightOracle(
        ...
        if (_chainsightOracle != address(0)) { /* FOR COVERAGE TESTING */ }
        Require.that(
    ...
    function _ownerSetChainsightSender(
        ...
        if (_chainsightSender != address(0)) { /* FOR COVERAGE TESTING */ }
        Require.that(
