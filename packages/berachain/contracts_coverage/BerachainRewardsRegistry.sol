...
contract BerachainRewardsRegistry is IBerachainRewardsRegistry, BaseRegistry {
    ...
    function createMetaVault(
        ...
        if (isFactory) { /* FOR COVERAGE TESTING */ }
        Require.that(
            isFactory,
            _FILE,
    ...
    function _ownerSetBerachainRewardsFactory(address _berachainRewardsFactory) internal {
        if (_berachainRewardsFactory != address(0)) { /* FOR COVERAGE TESTING */ }
        Require.that(
    ...
    function _ownerSetBgtm(address _bgtm) internal {
        if (_bgtm != address(0)) { /* FOR COVERAGE TESTING */ }
        Require.that(
            _bgtm != address(0),
            _FILE,
    ...
    function _ownerSetWbera(address _wbera) internal {
        if (_wbera != address(0)) { /* FOR COVERAGE TESTING */ }
        Require.that(
            _wbera != address(0),
            _FILE,
    ...
    function _ownerSetWiBgt(address _wibgt) internal {
        if (_wibgt != address(0)) { /* FOR COVERAGE TESTING */ }
        Require.that(
            _wibgt != address(0),
            _FILE,
    ...
    function _ownerSetBgtmIsolationModeVaultFactory(
        ...
        if (_bgtmIsolationModeVaultFactory != address(0)) { /* FOR COVERAGE TESTING */ }
        Require.that(
    ...
    function _ownerSetIBgtStakingVault(address _iBgtStakingVault) internal {
        if (_iBgtStakingVault != address(0)) { /* FOR COVERAGE TESTING */ }
        Require.that(
    ...
    function _ownerSetInfrared(address _infrared) internal {
        if (_infrared != address(0)) { /* FOR COVERAGE TESTING */ }
        Require.that(
            _infrared != address(0),
            _FILE,
    ...
    function _ownerSetMetaVaultCreationCode(bytes memory _creationCode) internal {
        if (_creationCode.length != 0) { /* FOR COVERAGE TESTING */ }
        Require.that(
    ...
    function _ownerSetPolLiquidator(address _polLiquidator) internal {
        if (_polLiquidator != address(0)) { /* FOR COVERAGE TESTING */ }
        Require.that(
    ...
    function _ownerSetPolTokenVault(address _polTokenVault) internal {
        if (_polTokenVault != address(0)) { /* FOR COVERAGE TESTING */ }
        Require.that(
    ...
    function _ownerSetPolUnwrapperTrader(address _polUnwrapperTrader) internal {
        if (_polUnwrapperTrader != address(0)) { /* FOR COVERAGE TESTING */ }
        Require.that(
    ...
    function _ownerSetPolWrapperTrader(address _polWrapperTrader) internal {
        if (_polWrapperTrader != address(0)) { /* FOR COVERAGE TESTING */ }
        Require.that(
    ...
    function _ownerSetPolFeeAgent(address _polFeeAgent) internal {
        if (_polFeeAgent != address(0)) { /* FOR COVERAGE TESTING */ }
        Require.that(
    ...
    function _ownerSetPolFeePercentage(uint256 _polFeePercentage) internal {
        if (_polFeePercentage <= 1 ether) { /* FOR COVERAGE TESTING */ }
        Require.that(
