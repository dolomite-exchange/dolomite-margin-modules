...
// /**
//  * @title   BGTMIsolationModeUnwrapperTraderV2
//  * @author  Dolomite
//  *
//  * @notice  Used for unwrapping BGTM (already is exchanged in wbera) into WBERA. Upon settlement,
//  *          the burned WBERA is sent from the user's vault to this contract and dBGT is burned from `DolomiteMargin`.
//  */
// contract BGTMIsolationModeUnwrapperTraderV2 is IsolationModeUnwrapperTraderV2 {

//     // ============ Constants ============

//     bytes32 private constant _FILE = "BGTMIsolationModeUnwrapperV2";
