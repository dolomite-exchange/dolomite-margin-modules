...
/**
 * @title   GenericTraderProxyBaseForLiquidator
 * @author  Dolomite
 *
 * @notice  GenericTraderProxyBase but removes internal trade support
 */
abstract contract GenericTraderProxyBaseForLiquidator is IGenericTraderBase {

    // ========================================================
    // ====================== Constants =======================
    // ========================================================

    bytes32 private constant _FILE = "GenericTraderProxyBaseLiquidator";
        ...
        returns (uint256)
    {
        ...
        for (uint256 i; i < tradersPathLength; ++i) {
            if (_isUnwrapperTraderType(_tradersPath[i].traderType)) {
                ...
                revert("Internal liquidity not supported for liquidations");
            } else {
