    ...
    OnlyDolomiteMargin
{
    ...
    function _transfer(
        ...
        uint256 _marketId = marketId();
        IDolomiteStructs.AccountInfo[] memory accounts = _getAccounts(_from, _to);
        IDolomiteStructs.ActionArgs[] memory actions = _getTransferActions(_amount, _marketId);
