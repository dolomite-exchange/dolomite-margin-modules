...
/**
 * @title   TestIsolationModeTokenVaultV2
 * @author  Dolomite
 *
 * @notice  A test contract for the IsolationModeTokenVaultV2 contract.
 */
contract TestIsolationModeTokenVaultV2 is IsolationModeTokenVaultV2 {
