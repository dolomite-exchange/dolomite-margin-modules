...
/**
 * @title   InternalSafeDelegateCallLib
 * @author  Dolomite
 *
 * @notice  Library contract for handling expiration logic
 */
library InternalSafeDelegateCallLib {

    // ============ Constants ============

    bytes32 private constant _FILE = "InternalSafeDelegateCallLib";

    // ============ Functions ============

    function safeDelegateCall(address _target, bytes memory _calldata) internal returns (bytes memory) {
