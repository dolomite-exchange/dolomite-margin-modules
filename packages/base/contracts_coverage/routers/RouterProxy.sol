 ...
 * @author  Dolomite
 *
 * @notice  Base contract for router contracts. Contains helpers for validating address changes
 */
contract RouterProxy is ProxyContractHelpers, OnlyDolomiteMarginForUpgradeable {

    // ===================== Constants =====================

    bytes32 private constant _FILE = "RouterProxy";
    ...
    constructor(
        ...
        Address.functionDelegateCall(
            ...
            "RouterProxy: Initialization failed"
        );
    }
    ...
    function upgradeToAndCall(
        ...
        _setImplementation(_newImplementation);
        Address.functionDelegateCall(implementation(), _upgradeCalldata, "RouterProxy: Upgrade failed");
    }
