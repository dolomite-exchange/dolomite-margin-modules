...
export interface IIsolationModeWrapperTraderV2Interface
...
export interface IIsolationModeWrapperTraderV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IIsolationModeWrapperTraderV2Interface;
