...
export interface IIsolationModeUnwrapperTraderInterface
  extends utils.Interface {
  functions: {
    "actionsLength()": FunctionFragment;
    "createActionsForUnwrapping(uint256,uint256,address,address,uint256,uint256,uint256,uint256,bytes)": FunctionFragment;
...
export interface IIsolationModeUnwrapperTrader extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IIsolationModeUnwrapperTraderInterface;
