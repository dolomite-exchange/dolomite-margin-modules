...
export interface IIsolationModeVaultFactoryInterface extends utils.Interface {
  functions: {
...
export interface IIsolationModeVaultFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IIsolationModeVaultFactoryInterface;
