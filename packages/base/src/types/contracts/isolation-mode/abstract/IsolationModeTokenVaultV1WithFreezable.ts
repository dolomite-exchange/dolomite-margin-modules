...
export interface IsolationModeTokenVaultV1WithFreezableInterface
...
export interface IsolationModeTokenVaultV1WithFreezable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsolationModeTokenVaultV1WithFreezableInterface;
