...
export interface IsolationModeWrapperTraderV2Interface extends utils.Interface {
  functions: {
...
export interface IsolationModeWrapperTraderV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsolationModeWrapperTraderV2Interface;
