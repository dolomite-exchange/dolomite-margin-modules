...
export interface IsolationModeTokenVaultV1Interface extends utils.Interface {
  functions: {
...
export interface IsolationModeTokenVaultV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsolationModeTokenVaultV1Interface;
