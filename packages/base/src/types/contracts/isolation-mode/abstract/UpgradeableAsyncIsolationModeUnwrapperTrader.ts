...
export interface UpgradeableAsyncIsolationModeUnwrapperTraderInterface
...
export interface UpgradeableAsyncIsolationModeUnwrapperTrader
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UpgradeableAsyncIsolationModeUnwrapperTraderInterface;
