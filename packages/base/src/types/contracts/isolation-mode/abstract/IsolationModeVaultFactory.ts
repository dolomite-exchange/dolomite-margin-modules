...
export interface IsolationModeVaultFactoryInterface extends utils.Interface {
  functions: {
...
export interface IsolationModeVaultFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsolationModeVaultFactoryInterface;
