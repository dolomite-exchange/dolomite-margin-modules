...
export interface SimpleIsolationModeUnwrapperTraderV2Interface
...
export interface SimpleIsolationModeUnwrapperTraderV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SimpleIsolationModeUnwrapperTraderV2Interface;
