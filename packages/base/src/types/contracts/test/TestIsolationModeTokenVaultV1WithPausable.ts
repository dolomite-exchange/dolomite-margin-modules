...
export interface TestIsolationModeTokenVaultV1WithPausableInterface
...
export interface TestIsolationModeTokenVaultV1WithPausable
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestIsolationModeTokenVaultV1WithPausableInterface;
