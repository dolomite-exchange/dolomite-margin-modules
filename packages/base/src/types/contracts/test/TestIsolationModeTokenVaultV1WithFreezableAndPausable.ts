...
export interface TestIsolationModeTokenVaultV1WithFreezableAndPausableInterface
  ...
  functions: {
    ...
    "setIsExternalRedemptionPaused(bool)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setIsExternalRedemptionPaused",
    values: [boolean]
  ): string;
  encodeFunctionData(
...
export interface TestIsolationModeTokenVaultV1WithFreezableAndPausable
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestIsolationModeTokenVaultV1WithFreezableAndPausableInterface;
  ...
  functions: {
    ...
    setIsExternalRedemptionPaused(
      _newIsExternalRedemptionPaused: boolean,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
