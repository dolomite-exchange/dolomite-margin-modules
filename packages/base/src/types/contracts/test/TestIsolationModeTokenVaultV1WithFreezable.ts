...
export interface TestIsolationModeTokenVaultV1WithFreezableInterface
...
export interface TestIsolationModeTokenVaultV1WithFreezable
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestIsolationModeTokenVaultV1WithFreezableInterface;
