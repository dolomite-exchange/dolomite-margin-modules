...
export interface TestIsolationModeTokenVaultV1WithPausableAndOnlyEoaInterface
...
export interface TestIsolationModeTokenVaultV1WithPausableAndOnlyEoa
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestIsolationModeTokenVaultV1WithPausableAndOnlyEoaInterface;
