...
export interface TestFreezableIsolationModeVaultFactoryInterface
  ...
  functions: {
    ...
    "createVaultNoInitialize(address)": FunctionFragment;
    "createVaultWithDifferentAccount(address,address)": FunctionFragment;
    ...
    "setAllowableCollateralMarketIds(uint256[])": FunctionFragment;
    "setAllowableDebtMarketIds(uint256[])": FunctionFragment;
    "setIsVaultDepositSourceWrapper(address,bool)": FunctionFragment;
    "setShouldSpendAllowance(bool)": FunctionFragment;
    ...
    "testEnqueueTransfer(address,address,uint256,address)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "createVaultNoInitialize"
      | "createVaultWithDifferentAccount"
      | "decimals"
      ...
      | "setAllowableCollateralMarketIds"
      | "setAllowableDebtMarketIds"
      | "setIsVaultDepositSourceWrapper"
      | "setShouldSpendAllowance"
  ...
  encodeFunctionData(
    functionFragment: "createVaultNoInitialize",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "createVaultWithDifferentAccount",
    values: [string, string]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setAllowableCollateralMarketIds",
    values: [BigNumberish[]]
  ): string;
  encodeFunctionData(
    functionFragment: "setAllowableDebtMarketIds",
    values: [BigNumberish[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setShouldSpendAllowance",
    values: [boolean]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "testEnqueueTransfer",
...
export interface TestFreezableIsolationModeVaultFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestFreezableIsolationModeVaultFactoryInterface;
  ...
  functions: {
    ...
    setAllowableCollateralMarketIds(
      __allowableCollateralMarketIds: BigNumberish[],
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;

    setAllowableDebtMarketIds(
      __allowableDebtMarketIds: BigNumberish[],
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
    ...
    setShouldSpendAllowance(
      newShouldSpendAllowance: boolean,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
