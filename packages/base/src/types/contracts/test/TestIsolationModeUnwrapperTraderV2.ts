...
export interface TestIsolationModeUnwrapperTraderV2Interface
...
export interface TestIsolationModeUnwrapperTraderV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestIsolationModeUnwrapperTraderV2Interface;
