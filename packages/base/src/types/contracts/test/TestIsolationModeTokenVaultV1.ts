...
export interface TestIsolationModeTokenVaultV1Interface
  ...
  functions: {
    ...
    "callDepositOtherTokenIntoDolomiteMarginForVaultOwner(uint256,uint256,uint256)": FunctionFragment;
    ...
    "testReentrancy(bool)": FunctionFragment;
    "testReentrancyOnOtherFunction(bytes)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "callDepositOtherTokenIntoDolomiteMarginForVaultOwner"
  ...
  encodeFunctionData(
    functionFragment: "callDepositOtherTokenIntoDolomiteMarginForVaultOwner",
  ...
  encodeFunctionData(
    functionFragment: "testReentrancy",
    values: [boolean]
  ): string;
  encodeFunctionData(
    functionFragment: "testReentrancyOnOtherFunction",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
...
export interface TestIsolationModeTokenVaultV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestIsolationModeTokenVaultV1Interface;
