...
export const CHAINLINK_AUTOMATION_REGISTRY_MAP: Record<Network, string | undefined> = {
...
export const GMX_MAP: Record<Network.ArbitrumOne, TokenWithMarketId | undefined> = {
  [Network.ArbitrumOne]: {
