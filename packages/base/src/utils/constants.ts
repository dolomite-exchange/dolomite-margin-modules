...
type EverythingButBase =
  ...
  | Network.XLayer;
type ArbitrumAndBerachainAndMantle = Network.ArbitrumOne | Network.Berachain | Network.BerachainBartio | Network.Mantle;
...
export const SUBGRAPH_URL_MAP: Record<Network, string> = {
  ...
  [Network.Berachain]: '',
  [Network.BerachainBartio]: `${SUBGRAPH_BASE_URL}/subgraphs/dolomite-berachain/${SUBGRAPH_VERSION}`,
  [Network.BerachainCartio]: '',
  [Network.Ink]: '',
...
export const BGT_MAP: Record<Network.Berachain | Network.BerachainBartio, TokenWithMarketId> = {
  [Network.Berachain]: {
...
export const IBGT_MAP: Record<Network.Berachain | Network.BerachainBartio, TokenWithMarketId> = {
  [Network.Berachain]: {
...
export const CHAINLINK_PRICE_ORACLE_V1_MAP: Record<Network, string> = {
  ...
  [Network.BerachainBartio]: CoreDeployments.ChainlinkPriceOracleV1[Network.BerachainBartio].address,
  [Network.BerachainCartio]: CoreDeployments.ChainlinkPriceOracleV1[Network.BerachainCartio].address,
...
export const BERA_ETH_MAP: Record<Network.Berachain | Network.BerachainCartio, TokenWithMarketId> = {
  [Network.Berachain]: {
...
export const HONEY_MAP: Record<
  Network.Berachain | Network.BerachainBartio | Network.BerachainCartio,
  TokenWithMarketId
> = {
  [Network.Berachain]: {
...
export const NECT_MAP: Record<Network.Berachain | Network.BerachainCartio, TokenWithMarketId> = {
  [Network.Berachain]: {
...
export const RS_ETH_MAP: Record<Network.ArbitrumOne | Network.Berachain | Network.BerachainCartio, TokenWithMarketId> =
  {
    [Network.ArbitrumOne]: {
...
export const STONE_BTC_MAP: Record<
  Network.Berachain | Network.BerachainBartio | Network.BerachainCartio,
  TokenWithMarketId
> = {
  [Network.Berachain]: {
  ...
  [Network.BerachainCartio]: {
    address: '0x5d417e7798208E9285b5157498bBF23A23E421E7',
    marketId: 6,
  },
};
...
export const SOLV_BTC_MAP: Record<
  Network.Berachain | Network.BerachainBartio | Network.BerachainCartio,
  TokenWithMarketId
> = {
  [Network.Berachain]: {
...
export const SOLV_BTC_BBN_MAP: Record<
  Network.Berachain | Network.BerachainBartio | Network.BerachainCartio,
  TokenWithMarketId
> = {
  [Network.Berachain]: {
...
export const ST_BTC_MAP: Record<Network.Berachain | Network.BerachainCartio, TokenWithMarketId> = {
  [Network.Berachain]: {
...
export const S_USDA_MAP: Record<Network.Berachain | Network.BerachainCartio, TokenWithMarketId> = {
  [Network.Berachain]: {
...
export const UNI_BTC_MAP: Record<
  Network.ArbitrumOne | Network.Berachain | Network.BerachainBartio | Network.BerachainCartio,
  TokenWithMarketId
> = {
  [Network.ArbitrumOne]: {
  ...
  [Network.BerachainCartio]: {
    address: '0x16c041FB492ea3D5C70EDae9987653E4bc00B608',
    marketId: 7,
  },
};

export const USDA_MAP: Record<Network.Berachain | Network.BerachainCartio, TokenWithMarketId> = {
  [Network.Berachain]: {
...
export const USDE_MAP: Record<
  Network.ArbitrumOne | Network.Berachain | Network.BerachainCartio | Network.Mantle,
  TokenWithMarketId
> = {
  [Network.ArbitrumOne]: {
...
export const YL_BTC_LST_MAP: Record<Network.Berachain | Network.BerachainCartio, TokenWithMarketId> = {
  [Network.Berachain]: {
...
export const YL_PUMP_BTC_MAP: Record<Network.Berachain | Network.BerachainCartio, TokenWithMarketId> = {
  [Network.Berachain]: {
...
export const YL_ST_ETH_MAP: Record<Network.Berachain | Network.BerachainCartio, TokenWithMarketId> = {
  [Network.Berachain]: {
...
export const GNOSIS_SAFE_MAP: Record<Network, string> = {
  ...
  [Network.BerachainBartio]: '0x52d7BcB650c591f6E8da90f797A1d0Bfd8fD05F9',
...
export const INFRARED_MAP: Record<Network.Berachain | Network.BerachainBartio, string> = {
  [Network.Berachain]: '0xb71b3DaEA39012Fb0f2B14D2a9C86da9292fC126',
  [Network.BerachainBartio]: '0xe41779952f5485db5440452DFa43350556AA4673',
};

export const BERACHAIN_REWARDS_VAULT_FACTORY_MAP: Record<Network.Berachain | Network.BerachainBartio, string> = {
  [Network.Berachain]: '0x94Ad6Ac84f6C6FbA8b8CCbD71d9f4f101def52a8',
  [Network.BerachainBartio]: '0x2B6e40f65D82A0cB98795bC7587a71bfa49fBB2B',
};

export const BGTM_MAP: Record<Network.Berachain | Network.BerachainBartio, string> = {
  [Network.Berachain]: '0x9999999999999999999999999999999999999999', // @todo fix and update
  [Network.BerachainBartio]: '0x69dac87DEfB1c4700bB07F8375Ec01336742e919',
};

export const HONEY_USDC_BEX_LP_TOKEN_MAP: Record<Network.Berachain | Network.BerachainBartio, string> = {
  [Network.Berachain]: '0xF961a8f6d8c69E7321e78d254ecAfBcc3A637621',
  [Network.BerachainBartio]: '0xD69ADb6FB5fD6D06E6ceEc5405D95A37F96E3b96',
};
...
export const HONEY_USDC_BEX_NATIVE_REWARD_VAULT_MAP: Record<Network.Berachain | Network.BerachainBartio, string> = {
  [Network.Berachain]: '0xF99be47baf0c22B7eB5EAC42c8D91b9942Dc7e84',
  [Network.BerachainBartio]: '0xe3b9B72ba027FD6c514C0e5BA075Ac9c77C23Afa',
};

export const HONEY_WBERA_BEX_LP_TOKEN_MAP: Record<Network.Berachain | Network.BerachainBartio, string> = {
  [Network.Berachain]: '0x2c4a603A2aA5596287A06886862dc29d56DbC354',
  [Network.BerachainBartio]: '0xd28d852cbcc68DCEC922f6d5C7a8185dBaa104B7',
};

export const HONEY_WBERA_BEX_NATIVE_REWARD_VAULT_MAP: Record<Network.Berachain | Network.BerachainBartio, string> = {
  [Network.Berachain]: '0xC2BaA8443cDA8EBE51a640905A8E6bc4e1f9872c',
  [Network.BerachainBartio]: '0xAD57d7d39a487C04a44D3522b910421888Fb9C6d',
};

export const HONEY_WBERA_BEX_INFRARED_REWARD_VAULT_MAP: Record<Network.Berachain | Network.BerachainBartio, string> = {
  [Network.Berachain]: '0xA95Ff8097B0E405d1F4139F460fa4c89863784c0',
  [Network.BerachainBartio]: '0x5c5f9a838747fb83678ECe15D85005FD4F558237',
};
...
export const PAYABLE_TOKEN_MAP: Record<Network, TokenWithMarketId> = {
  ...
  [Network.BerachainBartio]: WBERA_MAP[Network.BerachainBartio],
  [Network.BerachainCartio]: WBERA_MAP[Network.BerachainCartio],
...
export const PENDLE_ROUTER_V3_MAP: Record<Network, string | undefined> = {
...
export const PUMP_BTC_MAP: Record<
  Network.ArbitrumOne | Network.Berachain | Network.BerachainCartio,
  TokenWithMarketId
> = {
  [Network.ArbitrumOne]: {
...
export const CHRONICLE_PRICE_SCRIBES_MAP: Record<
  Network.ArbitrumOne | Network.Berachain | Network.BerachainBartio | Network.Mantle,
...
> = {
  ...
  [Network.Berachain]: {
    ...
    [NECT_MAP[Network.Berachain].address]: {
      ...
      invertPrice: true, // TODO: check this
    },
    ...
    [STONE_BTC_MAP[Network.Berachain].address]: {
      scribeAddress: '0x8f01f70be5deea5d4273d9a299a1a609bf1649c0',
    },
  ...
  [Network.BerachainBartio]: {
    [STONE_BTC_MAP[Network.BerachainBartio].address]: {
    ...
    [UNI_BTC_MAP[Network.BerachainBartio].address]: {
      scribeAddress: '0x02a2f7F3109A4c6706A91C7c880225b440e3c8d7',
      tokenPairAddress: ADDRESS_ZERO,
    },
  },
...
> = {
  ...
  [Network.Berachain]: {
    ...
    [BERA_ETH_MAP[Network.Berachain].address]: {
      aggregatorAddress: '', // TODO: add this
      tokenPairAddress: WETH_MAP[Network.Berachain].address,
    },
  ...
  [Network.BerachainBartio]: {
    [WETH_MAP[Network.BerachainBartio].address]: {
