...
contract LiquidatorProxyV6Test is DolomiteForkTest {
    ...
    function test_liquidate_lossy_no_rake() public {
        ...
        */
        ...
        assertProtocolBalanceWei(dolomiteMargin, charlie, DEFAULT_ACCOUNT_NUMBER, daiMarketId, 0, true);
        assertEq(dai.balanceOf(address(dolomiteExchangeWrapper)), 945 ether);
    }
