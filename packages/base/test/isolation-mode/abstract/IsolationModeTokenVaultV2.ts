...
describe('IsolationModeTokenVaultV2', () => {
  ...
  let userVaultImplementation: TestIsolationModeTokenVaultV2;
  ...
  before(async () => {
    ...
    userVaultImplementation = await createContractWithLibrary('TestIsolationModeTokenVaultV2', { ...libraries }, []);
  ...
  describe('#nonReentrant', () => {
    ...
    it('should fail when reentrancy happens', async () => {
      await expectThrow(userVault.testReentrancy(true), 'IsolationModeTokenVaultV2: Reentrant call');
    });
  });

  describe('#initialize', () => {
    it('should fail when already initialized', async () => {
      await expectThrow(userVault.initialize(), 'IsolationModeTokenVaultV2: Already initialized');
    });
  });
  ...
  describe('#multicall', () => {
    ...
    it('should fail if calldata contains a disallowed function', async () => {
      ...
      await expectThrow(
        ...
        'IsolationModeVaultV2ActionsImpl: Disallowed multicall function',
      );
    });
    ...
    it('should fail if not called by owner', async () => {
      ...
      await expectThrow(
        ...
        `IsolationModeTokenVaultV2: Only owner or converter can call <${core.hhUser2.address.toLowerCase()}>`,
      );
    });
  });
  ...
  describe('#depositIntoVaultForDolomiteMargin', () => {
    ...
    it('should fail when reentrancy is triggered', async () => {
      ...
      await expectThrow(userVault.testReentrancyOnOtherFunction(tx.data!), 'IsolationModeTokenVaultV2: Reentrant call');
    });

    it('should fail when toAccountNumber is not 0', async () => {
      await expectThrow(
        userVault.depositIntoVaultForDolomiteMargin('1', amountWei),
        'IsolationModeVaultV2ActionsImpl: Invalid toAccountNumber <1>',
      );
    });
    ...
    it('should fail when not sent by vault owner nor factory', async () => {
      await expectThrow(
        ...
        `IsolationModeTokenVaultV2: Only owner or factory can call <${core.hhUser2.address.toLowerCase()}>`,
      );
    });
  });
  ...
  describe('#withdrawFromVaultForDolomiteMargin', () => {
    ...
    it('should fail when fromAccountNumber is not 0', async () => {
      await expectThrow(
        ...
        'IsolationModeVaultV2ActionsImpl: Invalid fromAccountNumber <1>',
      );
    });
    ...
    it('should fail when not sent by vault owner nor factory', async () => {
      await expectThrow(
        ...
        `IsolationModeTokenVaultV2: Only owner can call <${core.hhUser2.address.toLowerCase()}>`,
      );
    });
  });
  ...
  describe('#openBorrowPosition', () => {
    ...
    it('should fail when msg.value is not 0', async () => {
      await expectThrow(
        ...
        'IsolationModeTokenVaultV2: Cannot send ETH',
      );
    });
    ...
    it('should fail when fromAccountNumber != 0', async () => {
      await expectThrow(
        ...
        `IsolationModeVaultV2ActionsImpl: Invalid fromAccountNumber <${borrowAccountNumber}>`,
      );
    });
    ...
    it('should fail when toAccountNumber == 0', async () => {
      await expectThrow(
        ...
        `IsolationModeVaultV2ActionsImpl: Invalid toAccountNumber <${defaultAccountNumber}>`,
      );
    });
  });
  ...
  describe('#openMarginPosition', () => {
    ...
    it('should fail when toAccountNumber == 0', async () => {
      await expectThrow(
        ...
        `IsolationModeVaultV2ActionsImpl: Invalid borrowAccountNumber <${defaultAccountNumber}>`,
      );
    });
  });
  ...
  describe('#closeBorrowPositionWithUnderlyingVaultToken', () => {
    ...
    it('should fail when toAccountNumber == 0', async () => {
      await expectThrow(
        ...
        `IsolationModeVaultV2ActionsImpl: Invalid toAccountNumber <${borrowAccountNumber}>`,
      );
    });
  });
  ...
  describe('#closeBorrowPositionWithOtherTokens', () => {
    ...
    it('should fail when underlying is requested to be withdrawn', async () => {
      ...
      await expectThrow(
        ...
        `IsolationModeVaultV2ActionsImpl: Cannot withdraw market to wallet <${isolationModeMarketId.toString()}>`,
      );
    });
  ...
  describe('#transferIntoPositionWithOtherToken', () => {
    ...
    it('should fail when underlying token is used as transfer token', async () => {
      await expectThrow(
        ...
        `IsolationModeVaultV2ActionsImpl: Invalid marketId <${isolationModeMarketId.toString()}>`,
      );
    });
    ...
    it('should fail when transferring in an unsupported collateral token', async () => {
      ...
      await expectThrow(
        ...
        `IsolationModeVaultV2ActionsImpl: Market not allowed as collateral <${otherMarketId1.toString()}>`,
      );
    });
  });
  ...
  describe('#transferFromPositionWithOtherToken', () => {
    ...
    it('should fail when an invalid debt market is used', async () => {
      ...
      await expectThrow(
        ...
        `IsolationModeVaultV2ActionsImpl: Market not allowed as debt <${otherMarketId1}>`,
      );
    });
  });
  ...
  describe('#addCollateralAndSwapExactInputForOutput', () => {
    ...
    it('should work when tradeAccountNumber is 0 when marketIds are correct', async () => {
      ...
      await expectThrow(
        ...
        'IsolationModeVaultV2ActionsImpl: Invalid marketId for swap/add',
      );
    ...
    it('should fail if transfer all is for non-positive balance', async () => {
      ...
      await expectThrow(
        ...
        'IsolationModeVaultV2ActionsImpl: Invalid balance for transfer all',
      );
    });
  ...
  describe('#swapExactInputForOutputAndRemoveCollateral', () => {
    ...
    it('should work when tradeAccountNumber is 0 when marketIds are correct', async () => {
      ...
      await expectThrow(
        ...
        'IsolationModeVaultV2ActionsImpl: Invalid marketId for swap/remove',
      );
  ...
  describe('#swapExactInputForOutput', () => {
    ...
    it('should fail if tradeAccountNumber is 0', async () => {
      ...
      await expectThrow(
        ...
        'IsolationModeVaultV2ActionsImpl: Invalid tradeAccountNumber <0>',
      );
    });
    ...
    it('should fail if inputMarketId is not allowed debt', async () => {
      ...
      await expectThrow(
        ...
        `IsolationModeVaultV2ActionsImpl: Market not allowed as debt <${otherMarketId1.toString()}>`,
      );
    });
    ...
    it('should fail if outputMarketId is not allowed collateral', async () => {
      ...
      await expectThrow(
        ...
        `IsolationModeVaultV2ActionsImpl: Market not allowed as collateral <${otherMarketId2.toString()}>`,
      );
    });
    ...
    it('should fail if outputMarketId is not allowed debt', async () => {
      ...
      await expectThrow(
        ...
        `IsolationModeVaultV2ActionsImpl: Market not allowed as debt <${otherMarketId2.toString()}>`,
      );
    });
  });
  ...
  describe('#executeDepositIntoVault', () => {
    it('should fail when not called by factory', async () => {
      await expectThrow(
        ...
        `IsolationModeTokenVaultV2: Only factory can call <${core.hhUser1.address.toLowerCase()}>`,
      );
    });
  });
  ...
  describe('#requireNotLiquidatable', () => {
    ...
    it('should fail if liquidatable', async () => {
      ...
      await expectThrow(
        ...
        'IsolationModeVaultV2ActionsImpl: Account liquidatable',
      );
    });
  });
  ...
  describe('#requireOnlyConverter', () => {
    ...
    it('should fail if not token converter', async () => {
      await expectThrow(
        ...
        `IsolationModeTokenVaultV2: Only converter can call <${core.hhUser1.address.toLowerCase()}>`,
      );
    });
  });
