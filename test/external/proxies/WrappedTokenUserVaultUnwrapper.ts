...
describe('WrappedTokenUserVaultUnwrapper', () => {
  ...
  let unwrapper: TestWrappedTokenUserVaultUnwrapper;
  ...
  describe('#callFunction', () => {
    ...
    it('should fail if account.owner param is not a vault', async () => {
      ...
      await expectThrow(
        ...
        `WrappedTokenUserVaultUnwrapper: Account owner is not a vault <${core.hhUser1.address.toLowerCase()}>`,
      );
    });
    ...
    it('should fail if transferAmount param is 0', async () => {
      ...
      await expectThrow(
        ...
        'WrappedTokenUserVaultUnwrapper: Invalid transfer amount',
      );
    });
    ...
    it('should fail if vault underlying balance is less than the transfer amount (ISF)', async () => {
      ...
      await expectThrow(
        ...
        `WrappedTokenUserVaultUnwrapper: Insufficient balance <${amountWei.toString()}, ${amountWei.mul(111)
          .toString()}>`,
      );
    });
  });
