...
//       network,
//     });
//     underlyingToken = core.umamiEcosystem!.jUSDC.connect(core.hhUser1);
...
//       symbol: 'dglpUSDC',
//       name: 'Dolomite Isolation: Umami USDC',
//       decimals: 6,
...
//
//     await setupUSDCBalance(core, core.hhUser1, usdcAmount, core.umamiEcosystem!.glpAdapter);
//     await core.umamiEcosystem!.glpAdapter.connect(core.hhUser1).depositStable(usableUsdcAmount, true);
//     await core.umamiEcosystem!.jUSDC.connect(core.hhUser1).approve(vault.address, heldAmountWei);
