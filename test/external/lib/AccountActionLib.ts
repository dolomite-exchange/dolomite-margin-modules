...
describe('AccountActionLib', () => {
  ...
  describe('#encodeCallAction', () => {
    it('should work normally', async () => {
      ...
      const callAction = await testLib.connect(core.hhUser1).encodeCallAction(
        accountId,
        core.dolomiteAmmRouterProxy.address,
        callData,
      );
      ...
      expect(callAction.otherAddress).to.eq(core.dolomiteAmmRouterProxy.address);
  ...
  describe('#encodeInternalTradeAction', () => {
    it('should work normally', async () => {
      ...
      expect(tradeAction.otherAddress).to.eq(core.dolomiteAmmRouterProxy.address);
