...
library GmxV2Library {
    ...
    function checkVaultIsNotActive(
        ...
        if (!_registry.isAccountWaitingForCallback(_vault, _accountNumber)) { /* FOR COVERAGE TESTING */ }
        Require.that(!_registry.isAccountWaitingForCallback(_vault, _accountNumber),
            _FILE,
