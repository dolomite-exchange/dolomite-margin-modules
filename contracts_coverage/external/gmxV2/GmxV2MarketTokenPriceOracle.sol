...
contract GmxV2MarketTokenPriceOracle is IGmxV2MarketTokenPriceOracle, OnlyDolomiteMargin {
    ...
    returns (IDolomiteStructs.MonetaryPrice memory) {
        ...
        if (dolomiteMargin.getMarketIsClosing(dolomiteMargin.getMarketIdByTokenAddress(_token))) { /* FOR COVERAGE TESTING */ }
        Require.that(dolomiteMargin.getMarketIsClosing(dolomiteMargin.getMarketIdByTokenAddress(_token)),
            _FILE,
