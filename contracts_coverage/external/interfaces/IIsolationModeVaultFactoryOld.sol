...
/**
 * @title   IIsolationModeVaultFactoryOld
 * @author  Dolomite
 *
 * @notice  A wrapper contract around a certain token to offer isolation mode features for DolomiteMargin. This is used
 *          for dfsGLP on Arbitrum One since it has a slightly different interface.
 */
interface IIsolationModeVaultFactoryOld is IOnlyDolomiteMargin {
