...
/**
 * @title   TestUpgradeableIsolationModeWrapperTrader
 * @author  Dolomite
 *
 * @notice  A test contract for the UpgradeableIsolationModeWrapperTrader contract
 */
contract TestUpgradeableIsolationModeWrapperTrader is UpgradeableIsolationModeWrapperTrader {
