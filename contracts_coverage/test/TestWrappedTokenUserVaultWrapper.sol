...
import { WrappedTokenUserVaultWrapperTrader } from "../external/proxies/abstract/WrappedTokenUserVaultWrapperTrader.sol"; // solhint-disable-line max-line-length
 ...
 * @author  Dolomite
 *
 * @notice  A test contract for the WrappedTokenUserVaultWrapper contract.
 */
