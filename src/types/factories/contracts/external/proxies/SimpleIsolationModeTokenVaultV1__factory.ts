...
import type {
  ...
  SimpleIsolationModeTokenVaultV1Interface,
} from "../../../../contracts/external/proxies/SimpleIsolationModeTokenVaultV1";
...
export class SimpleIsolationModeTokenVaultV1__factory {
  static readonly abi = _abi;
  static createInterface(): SimpleIsolationModeTokenVaultV1Interface {
    return new utils.Interface(
      _abi
    ) as SimpleIsolationModeTokenVaultV1Interface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as SimpleIsolationModeTokenVaultV1;
  }
}
