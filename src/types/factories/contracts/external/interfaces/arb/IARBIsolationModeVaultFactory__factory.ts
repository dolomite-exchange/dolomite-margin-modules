...
import type {
  ...
  IARBIsolationModeVaultFactoryInterface,
} from "../../../../../contracts/external/interfaces/arb/IARBIsolationModeVaultFactory";
...
const _abi = [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract IARBRegistry",
        name: "",
        type: "address",
      },
    ],
...
export class IARBIsolationModeVaultFactory__factory {
  static readonly abi = _abi;
  static createInterface(): IARBIsolationModeVaultFactoryInterface {
    return new utils.Interface(_abi) as IARBIsolationModeVaultFactoryInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as IARBIsolationModeVaultFactory;
  }
}
