...
import type {
  ...
  IPendleYtGLP2024IsolationModeVaultFactoryInterface,
} from "../../../../../contracts/external/interfaces/pendle/IPendleYtGLP2024IsolationModeVaultFactory";
...
const _abi = [
    ...
    inputs: [
      {
        ...
        name: "_pendleGLPRegistry",
        type: "address",
      },
    ],
    name: "PendleGLPRegistrySet",
    type: "event",
  },
  {
    anonymous: false,
    ...
    inputs: [
      {
        indexed: false,
        internalType: "uint256",
        name: "_ytMaturityTimestamp",
        type: "uint256",
      },
    ],
    name: "YtMaturityTimestampSet",
    type: "event",
  },
  {
    inputs: [],
  ...
  },
  {
    ...
    name: "ownerSetPendleGLPRegistry",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  },
  {
    inputs: [
      {
        internalType: "uint256",
        name: "_ytMaturityTimstamp",
        type: "uint256",
      },
    ],
    name: "ownerSetYtMaturityTimestamp",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
...
export class IPendleYtGLP2024IsolationModeVaultFactory__factory {
  static readonly abi = _abi;
  static createInterface(): IPendleYtGLP2024IsolationModeVaultFactoryInterface {
    return new utils.Interface(
      _abi
    ) as IPendleYtGLP2024IsolationModeVaultFactoryInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as IPendleYtGLP2024IsolationModeVaultFactory;
  }
}
