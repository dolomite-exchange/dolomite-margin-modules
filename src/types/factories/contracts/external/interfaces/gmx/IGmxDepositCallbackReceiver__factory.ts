...
import type {
  ...
  IGmxDepositCallbackReceiverInterface,
} from "../../../../../contracts/external/interfaces/gmx/IGmxDepositCallbackReceiver";
...
export class IGmxDepositCallbackReceiver__factory {
  static readonly abi = _abi;
  static createInterface(): IGmxDepositCallbackReceiverInterface {
    return new utils.Interface(_abi) as IGmxDepositCallbackReceiverInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as IGmxDepositCallbackReceiver;
  }
}
