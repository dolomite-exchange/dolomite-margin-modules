...
export interface MagicGLPWithChainlinkAutomationPriceOracleInterface
...
export interface MagicGLPWithChainlinkAutomationPriceOracle
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MagicGLPWithChainlinkAutomationPriceOracleInterface;
