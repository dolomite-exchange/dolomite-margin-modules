...
export interface PlutusVaultGLPIsolationModeVaultFactoryInterface
...
export interface PlutusVaultGLPIsolationModeVaultFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PlutusVaultGLPIsolationModeVaultFactoryInterface;
