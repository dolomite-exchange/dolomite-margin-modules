...
export interface ARBIsolationModeTokenVaultV1Interface extends utils.Interface {
  functions: {
...
export interface ARBIsolationModeTokenVaultV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ARBIsolationModeTokenVaultV1Interface;
