...
export interface JonesUSDCIsolationModeUnwrapperTraderV2Interface
...
export interface JonesUSDCIsolationModeUnwrapperTraderV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: JonesUSDCIsolationModeUnwrapperTraderV2Interface;
