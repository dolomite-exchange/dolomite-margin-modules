...
export interface IsolationModeUpgradeableProxyV1Interface
...
export interface IsolationModeUpgradeableProxyV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsolationModeUpgradeableProxyV1Interface;
