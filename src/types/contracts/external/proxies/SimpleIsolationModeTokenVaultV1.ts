...
export interface SimpleIsolationModeTokenVaultV1Interface
...
export interface SimpleIsolationModeTokenVaultV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SimpleIsolationModeTokenVaultV1Interface;
