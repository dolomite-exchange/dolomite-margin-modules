...
export interface SimpleIsolationModeWrapperTraderV2Interface
...
export interface SimpleIsolationModeWrapperTraderV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SimpleIsolationModeWrapperTraderV2Interface;
