...
export interface IsolationModeUnwrapperTraderV2Interface
...
export interface IsolationModeUnwrapperTraderV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsolationModeUnwrapperTraderV2Interface;
