...
export interface IsolationModeTokenVaultV1WithFreezableAndPausableInterface
...
export interface IsolationModeTokenVaultV1WithFreezableAndPausable
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsolationModeTokenVaultV1WithFreezableAndPausableInterface;
