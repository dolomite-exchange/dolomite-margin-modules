...
export interface IsolationModeTraderProxyInterface extends utils.Interface {
  functions: {
...
export interface IsolationModeTraderProxy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IsolationModeTraderProxyInterface;
