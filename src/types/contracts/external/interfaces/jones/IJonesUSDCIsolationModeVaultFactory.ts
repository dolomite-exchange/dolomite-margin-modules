...
export interface IJonesUSDCIsolationModeVaultFactoryInterface
...
export interface IJonesUSDCIsolationModeVaultFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IJonesUSDCIsolationModeVaultFactoryInterface;
