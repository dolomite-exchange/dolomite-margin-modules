...
export interface IPendlePtMarketInterface extends utils.Interface {
  functions: {
...
export interface IPendlePtMarket extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPendlePtMarketInterface;
