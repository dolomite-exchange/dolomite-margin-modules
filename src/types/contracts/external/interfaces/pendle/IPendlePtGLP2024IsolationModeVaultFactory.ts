...
export interface IPendlePtGLP2024IsolationModeVaultFactoryInterface
...
export interface IPendlePtGLP2024IsolationModeVaultFactory
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPendlePtGLP2024IsolationModeVaultFactoryInterface;
