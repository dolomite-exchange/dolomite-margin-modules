...
export interface IChainlinkAccessControlAggregatorInterface
  ...
  getFunction(
    nameOrSignatureOrTopic: "maxAnswer" | "minAnswer"
  ): FunctionFragment;
...
export interface IChainlinkAccessControlAggregator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IChainlinkAccessControlAggregatorInterface;
