...
export interface IPlutusVaultGLPInterface extends utils.Interface {
  functions: {
...
export interface IPlutusVaultGLP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IPlutusVaultGLPInterface;
