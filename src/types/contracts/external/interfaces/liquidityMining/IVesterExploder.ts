...
export interface IVesterExploderInterface extends utils.Interface {
  functions: {
...
export interface IVesterExploder extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IVesterExploderInterface;
