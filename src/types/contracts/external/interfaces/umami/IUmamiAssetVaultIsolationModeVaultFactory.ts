...
export interface IUmamiAssetVaultIsolationModeVaultFactoryInterface
...
export interface IUmamiAssetVaultIsolationModeVaultFactory
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IUmamiAssetVaultIsolationModeVaultFactoryInterface;
