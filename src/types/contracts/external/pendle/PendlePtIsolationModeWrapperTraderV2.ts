...
export interface PendlePtIsolationModeWrapperTraderV2Interface
  extends utils.Interface {
  functions: {
    "DOLOMITE_MARGIN()": FunctionFragment;
    "DOLOMITE_REGISTRY()": FunctionFragment;
    "PENDLE_REGISTRY()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "PENDLE_REGISTRY",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface PendlePtIsolationModeWrapperTraderV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PendlePtIsolationModeWrapperTraderV2Interface;
  ...
  functions: {
    ...
    PENDLE_REGISTRY(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    PENDLE_REGISTRY(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    PENDLE_REGISTRY(overrides?: CallOverrides): Promise<PopulatedTransaction>;
