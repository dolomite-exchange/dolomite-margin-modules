...
export interface PendleYtGLP2024IsolationModeVaultFactoryInterface
  ...
  functions: {
    ...
    "ownerSetPendleGLPRegistry(address)": FunctionFragment;
    "ownerSetUserVaultImplementation(address)": FunctionFragment;
    "ownerSetYtMaturityTimestamp(uint256)": FunctionFragment;
    "pendleGLPRegistry()": FunctionFragment;
    ...
    "ytMaturityTimestamp()": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "ownerSetPendleGLPRegistry"
      | "ownerSetUserVaultImplementation"
      | "ownerSetYtMaturityTimestamp"
      | "pendleGLPRegistry"
      | "symbol"
      | "totalSupply"
      | "transfer"
  ...
  encodeFunctionData(
    functionFragment: "ownerSetPendleGLPRegistry",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "ownerSetYtMaturityTimestamp",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "pendleGLPRegistry",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "ytMaturityTimestamp",
    values?: undefined
  ): string;
  ...
  events: {
    ...
    "PendleGLPRegistrySet(address)": EventFragment;
    ...
    "YtMaturityTimestampSet(uint256)": EventFragment;
  };
  ...
  getEvent(nameOrSignatureOrTopic: "PendleGLPRegistrySet"): EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "YtMaturityTimestampSet"): EventFragment;
}
...
export interface PendleGLPRegistrySetEventObject {
  _pendleGLPRegistry: string;
}
export type PendleGLPRegistrySetEvent = TypedEvent<
  [string],
  PendleGLPRegistrySetEventObject
>;

export type PendleGLPRegistrySetEventFilter =
  TypedEventFilter<PendleGLPRegistrySetEvent>;
...
export interface YtMaturityTimestampSetEventObject {
  _ytMaturityTimestamp: BigNumber;
}
export type YtMaturityTimestampSetEvent = TypedEvent<
  [BigNumber],
  YtMaturityTimestampSetEventObject
>;

export type YtMaturityTimestampSetEventFilter =
  TypedEventFilter<YtMaturityTimestampSetEvent>;

export interface PendleYtGLP2024IsolationModeVaultFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PendleYtGLP2024IsolationModeVaultFactoryInterface;
  ...
  functions: {
    ...
    ownerSetYtMaturityTimestamp(
      _ytMaturityTimestamp: BigNumberish,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;

    pendleGLPRegistry(overrides?: CallOverrides): Promise<[string]>;
    ...
    ytMaturityTimestamp(overrides?: CallOverrides): Promise<[BigNumber]>;
  };
  ...
  filters: {
    ...
    "PendleGLPRegistrySet(address)"(
      _pendleGLPRegistry?: null
    ): PendleGLPRegistrySetEventFilter;
    PendleGLPRegistrySet(
      _pendleGLPRegistry?: null
    ): PendleGLPRegistrySetEventFilter;
    ...
    "YtMaturityTimestampSet(uint256)"(
      _ytMaturityTimestamp?: null
    ): YtMaturityTimestampSetEventFilter;
    YtMaturityTimestampSet(
      _ytMaturityTimestamp?: null
    ): YtMaturityTimestampSetEventFilter;
  };
  ...
  estimateGas: {
    ...
    pendleGLPRegistry(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    pendleGLPRegistry(overrides?: CallOverrides): Promise<PopulatedTransaction>;
