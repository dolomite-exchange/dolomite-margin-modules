...
export interface PendleGLPRegistryInterface extends utils.Interface {
  functions: {
...
export interface PendleGLPRegistry extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PendleGLPRegistryInterface;
