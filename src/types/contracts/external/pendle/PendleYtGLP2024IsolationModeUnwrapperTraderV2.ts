...
export interface PendleYtGLP2024IsolationModeUnwrapperTraderV2Interface
...
export interface PendleYtGLP2024IsolationModeUnwrapperTraderV2
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PendleYtGLP2024IsolationModeUnwrapperTraderV2Interface;
