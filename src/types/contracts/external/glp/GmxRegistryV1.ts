...
export declare namespace GmxRegistryV1 {
  export type InitializerStruct = {
    bnGmx: string;
    esGmx: string;
    fsGlp: string;
    glp: string;
    glpManager: string;
    glpRewardsRouter: string;
    gmx: string;
    gmxRewardsRouter: string;
    gmxVault: string;
    sGlp: string;
    sGmx: string;
    sbfGmx: string;
  ...
  export type InitializerStructOutput = [
    string,
    string,
    string,
    string,
...
export interface GmxRegistryV1Interface extends utils.Interface {
  functions: {
    ...
    "initialize((address,address,address,address,address,address,address,address,address,address,address,address,address,address),address)": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [GmxRegistryV1.InitializerStruct, string]
  ): string;
  encodeFunctionData(
...
export interface GmxRegistryV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GmxRegistryV1Interface;
  ...
  functions: {
    ...
    initialize(
      _initializer: GmxRegistryV1.InitializerStruct,
      _dolomiteRegistry: string,
