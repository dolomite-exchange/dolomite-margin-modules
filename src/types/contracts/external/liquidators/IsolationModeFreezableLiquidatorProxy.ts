...
export interface IsolationModeFreezableLiquidatorProxyInterface
  ...
  functions: {
    ...
    "minOutputPercentageUpperBound()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "minOutputPercentageUpperBound",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface IsolationModeFreezableLiquidatorProxy extends BaseContract {
  ...
  minOutputPercentageUpperBound(overrides?: CallOverrides): Promise<BigNumber>;
