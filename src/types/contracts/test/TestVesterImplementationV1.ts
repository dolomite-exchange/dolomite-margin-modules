...
export interface TestVesterImplementationV1Interface extends utils.Interface {
  functions: {
...
export interface TestVesterImplementationV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestVesterImplementationV1Interface;
