...
export interface TestVesterImplementationV2Interface extends utils.Interface {
  functions: {
    ...
    "callClosePositionAndBuyTokensAndTriggerReentrancy(uint256,uint256,uint256,uint256)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "balanceOf"
      | "baseURI"
      | "callClosePositionAndBuyTokensAndTriggerReentrancy"
  ...
  encodeFunctionData(
    functionFragment: "callClosePositionAndBuyTokensAndTriggerReentrancy",
...
export interface TestVesterImplementationV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestVesterImplementationV2Interface;
  ...
  functions: {
    ...
    nextNftId(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    nextNftId(overrides?: CallOverrides): Promise<PopulatedTransaction>;
