...
export interface TestGmxV2IsolationModeUnwrapperTraderV2Interface
  ...
  functions: {
    ...
    "vaultCreateWithdrawalInfo(bytes32,address,uint256,uint256,address,uint256,bool,bytes)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "vaultCreateWithdrawalInfo",
    values: [
      BytesLike,
      string,
      BigNumberish,
...
export interface TestGmxV2IsolationModeUnwrapperTraderV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestGmxV2IsolationModeUnwrapperTraderV2Interface;
