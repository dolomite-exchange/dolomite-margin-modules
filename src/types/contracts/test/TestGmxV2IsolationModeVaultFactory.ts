...
export interface TestGmxV2IsolationModeVaultFactoryInterface
  ...
  functions: {
    ...
    "reversionType()": FunctionFragment;
    "setIsVaultDepositSourceWrapper(address,bool)": FunctionFragment;
    "setReversionType(uint8)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "reversionType",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setReversionType",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface TestGmxV2IsolationModeVaultFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestGmxV2IsolationModeVaultFactoryInterface;
  ...
  functions: {
    ...
    reversionType(overrides?: CallOverrides): Promise<[number]>;
  ...
  estimateGas: {
    ...
    reversionType(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    reversionType(overrides?: CallOverrides): Promise<PopulatedTransaction>;
