...
export interface TestSimpleIsolationModeVaultFactoryInterface
...
export interface TestSimpleIsolationModeVaultFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestSimpleIsolationModeVaultFactoryInterface;
