...
export interface TestIsolationModeWrapperTraderV1Interface
...
export interface TestIsolationModeWrapperTraderV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestIsolationModeWrapperTraderV1Interface;
