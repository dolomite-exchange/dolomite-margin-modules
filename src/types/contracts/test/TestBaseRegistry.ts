...
export interface TestBaseRegistryInterface extends utils.Interface {
  functions: {
...
export interface TestBaseRegistry extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestBaseRegistryInterface;
