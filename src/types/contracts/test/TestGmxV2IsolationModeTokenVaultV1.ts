...
export interface TestGmxV2IsolationModeTokenVaultV1Interface
  ...
  functions: {
    ...
    "callFunctionAndTriggerReentrancy(bytes)": FunctionFragment;
    ...
    "initiateUnwrappingWithLiquidationTrue(uint256,uint256,address,uint256,bytes)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "callFunctionAndTriggerReentrancy"
      | "cancelDeposit"
      | "cancelWithdrawal"
      ...
      | "initiateUnwrappingWithLiquidationTrue"
  ...
  encodeFunctionData(
    functionFragment: "callFunctionAndTriggerReentrancy",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "initiateUnwrappingWithLiquidationTrue",
    values: [BigNumberish, BigNumberish, string, BigNumberish, BytesLike]
  ): string;
  encodeFunctionData(
...
export interface TestGmxV2IsolationModeTokenVaultV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestGmxV2IsolationModeTokenVaultV1Interface;
  ...
  functions: {
    ...
    callFunctionAndTriggerReentrancy(
      _callDataWithSelector: BytesLike,
      overrides?: PayableOverrides & { from?: string }
    ): Promise<ContractTransaction>;
