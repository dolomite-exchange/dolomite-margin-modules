...
export interface TestIsolationModeUnwrapperTraderV1Interface
  extends utils.Interface {
  functions: {
    "DOLOMITE_MARGIN()": FunctionFragment;
    "OUTPUT_MARKET_ID()": FunctionFragment;
    "OUTPUT_TOKEN()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "OUTPUT_MARKET_ID",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "OUTPUT_TOKEN",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface TestIsolationModeUnwrapperTraderV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestIsolationModeUnwrapperTraderV1Interface;
  ...
  functions: {
    ...
    OUTPUT_MARKET_ID(overrides?: CallOverrides): Promise<[BigNumber]>;

    OUTPUT_TOKEN(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    OUTPUT_TOKEN(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    OUTPUT_MARKET_ID(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    OUTPUT_TOKEN(overrides?: CallOverrides): Promise<PopulatedTransaction>;
