...
export interface TestHandlerRegistryInterface extends utils.Interface {
  functions: {
...
export interface TestHandlerRegistry extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestHandlerRegistryInterface;
