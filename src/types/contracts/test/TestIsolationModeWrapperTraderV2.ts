...
export interface TestIsolationModeWrapperTraderV2Interface
  extends utils.Interface {
  functions: {
    "DOLOMITE_MARGIN()": FunctionFragment;
    "DOLOMITE_REGISTRY()": FunctionFragment;
    "INPUT_TOKEN()": FunctionFragment;
...
export interface TestIsolationModeWrapperTraderV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestIsolationModeWrapperTraderV2Interface;
  ...
  functions: {
    ...
    INPUT_TOKEN(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    INPUT_TOKEN(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    INPUT_TOKEN(overrides?: CallOverrides): Promise<PopulatedTransaction>;
