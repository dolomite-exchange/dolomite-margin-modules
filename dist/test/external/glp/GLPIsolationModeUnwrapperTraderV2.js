...
describe('GLPIsolationModeUnwrapperTraderV2', () => {
    ...
    describe('Actions.Call and Actions.Sell for non-liquidation', () => {
        ...
        it('should fail for invalid input market', async () => {
            const solidAccountId = 0;
            const liquidAccountId = 0;
            await (0, assertions_1.expectThrow)(unwrapper.createActionsForUnwrapping(solidAccountId, liquidAccountId, vault.address, vault.address, core.marketIds.usdc, core.marketIds.weth, no_deps_constants_1.ZERO_BI, amountWei, no_deps_constants_1.BYTES_EMPTY), `IsolationModeUnwrapperTraderV2: Invalid input market <${core.marketIds.weth.toString()}>`);
        });
    });
    describe('#exchange', () => {
