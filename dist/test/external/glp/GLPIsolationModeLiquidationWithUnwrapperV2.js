...
describe('GLPLiquidationWithUnwrapperV2', () => {
    ...
    before(async () => {
        ...
        unwrapper = await (0, gmx_1.createGLPUnwrapperTraderV2)(core, factory, gmxRegistry);
        wrapper = await (0, gmx_1.createGLPWrapperTraderV2)(core, factory, gmxRegistry);
